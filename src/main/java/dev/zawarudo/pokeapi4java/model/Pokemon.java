...
public class Pokemon implements Comparable<Pokemon> {
    ...
    public List<String> getTypes() {
        ...
        for (PokemonType t : this.types) {
            String name = Formatter.format(t.type.getName());
            if (t.slot == 1) {
                types.add(0, name);
            } else {
                types.add(name);
    ...
    public List<String> getAbilities() {
        ...
        for (Ability a : this.abilities) {
            String name = Formatter.format(a.ability.getName());
            abilities.add(name);
        }
        return abilities;
    }
     ...
     */
    public PokemonSpecies getPokemonSpecies() throws IOException, PokemonNotFoundException {
